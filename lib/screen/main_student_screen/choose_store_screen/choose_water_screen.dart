...
class ChooseWaterScreen extends StatefulWidget {
  final restaurantid;
  const ChooseWaterScreen({super.key, this.restaurantid});

  @override
  State<ChooseWaterScreen> createState() => _ChooseWaterScreenState();
}

class _ChooseWaterScreenState extends State<ChooseWaterScreen> {
  String type = "";
