...
class AddFoodAlertDialog extends StatefulWidget {
  final restaurantid;
  const AddFoodAlertDialog({super.key, this.restaurantid});

  @override
  State<AddFoodAlertDialog> createState() => _AddFoodAlertDialogState();
}

class _AddFoodAlertDialogState extends State<AddFoodAlertDialog> {
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  buildBox("ชื่ออาหาร", Foodname),
                  // buildBox("ราคาอาหาร", Foodprice),
